...
/**
 * 擴充 Laravel 身分驗證機制，包含所有狀態的老師身份
 *
 * @package App\Extensions
 */
class IesAllStatusTeacherProvider implements UserProvider
{
    /**
    ...
    /**
     * IesAllStatusTeacherProvider constructor.
     *
    ...
    {
        return $this->repository->findForAllStatusTeacher($identifier);
    }
    ...
    public function retrieveByCredentials(array $credentials)
    {
        ...
        if (method_exists($this->model, 'findForTeacher')) {
            if (!array_key_exists('username', $credentials)) {
                return;
            }
            $user = $this->createModel()->findForTeacher($credentials['username']);
        } else {
